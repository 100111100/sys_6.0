...
<body>
<s:form  action="teacher_update.do" method="post" namespace="/">
    ...
    <fieldset class="fset">
       <table width="100%" align="center" border="0">
           ...
           <tr>
              ...
              <td>
       		<input type="text" id="birthday" name="teacher.birthday" 
              		readonly="readonly" class="ipt" value='<s:date name="teacher.birthday" format="yyyy-MM-dd"/>'>
              </td>
           ...
           <tr>
              ...
              <td>
       		      <input type="text" id="workDate" name="teacher.workDate"
              		readonly="readonly" class="ipt" value='<s:date name="teacher.workDate" format="yyyy-MM-dd"/>'>
              </td> 
           </tr>
