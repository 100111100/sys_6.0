...
<s:form namespace="/" id="f1" action="course_update" method="post">
       ...
       <table width="100%" align="center" border="0">
           ...
           <tr>
              ...
              <td>
                  ...
                  <s:hidden name="course.teacherId" cssClass="ipt" />
                 <s:textfield name="course.teacherName" cssClass="ipt" readonly="true" />
